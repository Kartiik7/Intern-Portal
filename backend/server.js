...
const connectDB = async () => {
  try {
    ...
    console.log('💡 Note: Make sure MongoDB is running or use MongoDB Atlas cloud connection');
    console.log('🔧 To install MongoDB locally: https://www.mongodb.com/try/download/community');
